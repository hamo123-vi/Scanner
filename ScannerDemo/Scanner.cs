...
{
    class Scanner : ConfigurationElement
    {
        private readonly DeviceInfo _deviceInfo;

        /*
         * Scanner settings read from App.config file via Config class
         * Amil Valjevac, 09.12.2021.
        */
        private int resolution = Config.Resolution;
        private int width_pixel = Config.WidthPixel;
        private int height_pixel = Config.HeightPixel;
        private int color_mode = Config.ColorMode;
